...
try {
    await sendEmail({
      email: user.email,
      subject: `Eweb Password Recovery`,
      message,
    });
...
exports.resetPassword = catchAsyncErrors(async(req,res,next)=>{
    ...
    //if use found and reset passwppod token was right for matching and change password 
...
//Get User Detail, for personal detail after login
...
exports.updateProfile = catchAsyncErrors(async (req, res, next) => {
  ...
  //i will ll add cloudinary later
